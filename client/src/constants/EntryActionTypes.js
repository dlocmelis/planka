...
export default {
  ...
  PUSH_SUBSCRIPTION_CREATE: `${PREFIX}/PUSH_SUBSCRIPTION_CREATE`,
  PUSH_SUBSCRIPTION_DELETE: `${PREFIX}/PUSH_SUBSCRIPTION_DELETE`,
  PUSH_SUBSCRIPTION_TEST: `${PREFIX}/PUSH_SUBSCRIPTION_TEST`,
};
