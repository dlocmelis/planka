...
export default {
  ...
  translation: {
    common: {
      ...
      addToHomeScreenHint: 'To enable push notifications, add PLANKA to your Home Screen.',
      ...
      buildSessionFailed: 'The build session could not be opened.',
      ...
      pushNotificationsNotSupported: 'Push notifications are not supported by this browser.',
      pushPermissionDeniedGuidance:
        'Notification permission is blocked. Reset it in your browser settings to enable push notifications.',
    ...
    action: {
      ...
      buildWithSession: 'Build this with a session',
      cancel: 'Cancel',
      copy: 'Copy',
      ...
      sortList_title: 'Sort List',
      start: 'Start',
      startBuildSession: 'Build something',
      stop: 'Stop',
      subscribe: 'Subscribe',
