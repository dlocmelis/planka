...
export default {
  ...
  translation: {
    ...
    pipeline: {
      accountThreads: 'потоков: {{count}}',
      accountsNone: 'Нет аккаунтов Claude',
      ago: '{{duration}} назад',
      alreadyAtCeiling:
        'Уже {{level}} — выше перемещение не поднимает; при равном приоритете очередь идёт по стадии, затем по возрасту',
      attempts: 'попыток: {{count}}',
      authApiKey: 'API-ключ',
      authEndpoint: 'эндпоинт {{host}}',
      authSubscription: 'подписка',
      buildType_e2e: 'e2e',
      buildType_express: 'экспресс',
      buildType_regular: 'обычная',
      cannotPassLocked: 'Выше задач e2e и пула аккаунтов ничего не поднимается',
      cardPaused: 'Карточка приостановлена',
      cardResumed: 'Карточка возобновлена',
      collapse: 'Свернуть полосу конвейера',
      container: 'Контейнер',
      countPackages: 'пакетов: {{count}}',
      countTests: 'тестов: {{count}}',
      deployFinishing: 'обрабатывает результат',
      deployIdle: 'Ничего не деплоится',
      deployNone: 'Нет репозиториев для деплоя',
      deployPreparing: 'готовит задачу',
      deployRecent: 'Последние деплои',
      deployResultAuth: 'сбой входа',
      deployResultError: 'сбой',
      deployResultNoResult: 'без результата',
      deployResultOk: 'ок',
      deployRiders: '+ {{count}} вместе с ним:',
      deployRunning: 'в потоке {{thread}}',
      deploySince: 'Занимает очередь',
      deployWaiting: 'Ждут ({{count}})',
      deployWaitingThread: 'ждёт свободный поток',
      deployingNow: 'деплоится',
      deploysChip: 'Деплои {{count}}',
      deploysChipTitle: '{{deploying}} деплоится, {{waiting}} ждут очереди',
      dispatchHeld: 'Запуск задержан',
      drainFailed: 'Не удалось переключить конвейер — изменение отменено',
      drainOff: 'Конвейер возобновлён',
      drainOn: 'Конвейер останавливается: текущие задачи завершатся, новые не начнутся',
      draining: 'Остановка',
      drainingSince: 'Остановка — {{actor}}, {{age}} назад',
      duration: 'Длительность',
      endpointOk: 'ок',
      endpointRefused: 'отказ',
      endpointStatus: 'Статус эндпоинта',
      endpointWarning: 'предупреждение',
      expand: 'Развернуть полосу конвейера',
      failedCount: 'упало: {{count}}',
      flaky: 'нестабильный: прошёл при повторе',
      idle: 'свободен',
      idleCapped: '⏳ лимит сессий',
      idleDraining: '⏸ остановка',
      idleLimited: '⛔ лимит использования',
      idleRetiring: 'выводится',
      inThisStatus: 'Время в этом состоянии',
      limitedChip: '{{names}}: лимит исчерпан',
      limitedNoThreads: '0 потоков — задачи ему не назначаются',
      limitedUnknown: 'лимит исчерпан — время сброса неизвестно',
      limitedUntil: 'лимит исчерпан до {{when}} (через {{duration}})',
      lockedE2E: 'Сессия e2e, за которой наблюдают, — выше неё ничего не поднимается',
      lockedPool: 'Работа пула аккаунтов, которую ждёт очередь, — выше неё ничего не поднимается',
      moveMenu: 'Поднять в очереди',
      moveUp: 'Выше',
      noAccount: 'Без аккаунта',
      noUsageWindows: 'Окон использования Anthropic нет (API-ключ или сторонний эндпоинт)',
      onlyUpward: 'Задачи можно только поднимать',
      openTerminal: 'Открыть терминал карточки',
      pause: 'Пауза',
      pauseCard: 'Приостановить карточку: её стадия остановится там, где она сейчас',
      pauseFailed: 'Не удалось приостановить карточку — изменение отменено',
      pausePipeline: 'Остановить конвейер (drain)',
      pausePipelineConfirm_title: 'Остановка конвейера',
      pausePipelineConfirmContent:
        'Текущие задачи завершатся, но новые не будут запускаться, пока конвейер не возобновят. Остановить весь конвейер?',
      paused: 'на паузе',
      pausedCards: 'На паузе ({{count}})',
      pausedCount: 'на паузе: {{count}}',
      pool: 'пул',
      profileFull: 'полный прогон перед слиянием',
      profileScoped: 'точечная проверка',
      progressPackages: '{{done}}/{{total}} пакетов',
      progressTests: '{{done}}/{{total}} тестов',
      queueCount: 'Очередь {{count}}',
      queueEmpty: 'Очередь пуста',
      queueTitle: 'Очередь ({{count}})',
      queuedPart: 'из них {{duration}} в ожидании слота',
      raiseFailed: 'Не удалось поднять карточку — изменение отменено',
      raiseHint:
        'Перетащите задачу вверх или воспользуйтесь её меню. Обгон задачи Normal ставит Priority: High, обгон High — Very High.',
      raiseUnchanged: 'Ничего не изменилось',
      raisedTo: 'Поднято до {{level}}, перед «{{name}}»',
      readingAge: 'Измерению {{duration}}',
      readingNone: 'Измерений использования ещё нет',
      readingStale: 'Устарело — последнее измерение {{when}} ({{duration}} назад)',
      recentStages: 'Недавно завершённые',
      recentStagesNone: 'Завершённых этапов пока не записано',
      recordedSince: '(записываются с {{date}})',
      resetsAt: 'сброс в {{when}}',
      resetsIn: 'сброс в {{when}}, через {{duration}}',
      resultError: 'ошибка',
      resultFail: 'провал',
      resultOk: 'успех',
      resultSkipped: 'пропущен',
      resume: 'Возобновить',
      resumeCard: 'Возобновить карточку',
      resumeFailed: 'Не удалось возобновить карточку — изменение отменено',
      resumePipeline: 'Возобновить конвейер',
      resumePipelineConfirm_title: 'Возобновление конвейера',
      resumePipelineConfirmContent: 'Новые задачи снова начнут запускаться. Возобновить конвейер?',
      selfRedeploy:
        'Самообновление оркестратора подготовлено {{age}} назад — замена ждёт завершения текущих задач. В нём:',
      stage: 'Стадия',
      statsAcceptanceRate: 'Доля принятых на пользовательском тестировании',
      statsAvgDuration: 'Средняя длительность',
      statsBoardSince:
        'История этой доски начинается {{date}}; более ранние периоды считаются с этой даты',
      statsBoardTitle: 'Поток доски (эта доска)',
      statsBoardTitleFiltered: 'Поток доски (эта доска), фильтр: {{filters}}',
      statsBoardUnavailable: 'Статистика доски недоступна',
      statsCompleted: 'Карточек завершено',
      statsDeployed: 'Карточек развёрнуто',
      statsDeploysFailed: 'Неудачных развёртываний',
      statsDeploysSucceeded: 'Успешных развёртываний',
      statsEntered: 'Карточек поступило',
      statsFailed: 'Не удалось прочитать статистику: {{error}}',
      statsFails: 'Сбоев',
      statsFilterAtLeast: 'от {{min}}',
      statsFilterAtMost: 'до {{max}}',
      statsFilterBetween: '{{min}} – {{max}}',
      statsFilterClear: 'Сбросить',
      statsFilterCost: 'Стоимость, $',
      ...
      statsFilterKeyword: 'Ключевое слово',
      statsFilterLabels: 'Метки',
      statsFilterMax: 'макс.',
      statsFilterMin: 'мин.',
      statsFilterNoOptions: 'Нечего выбрать',
      statsFilterQuoted: '«{{text}}»',
      statsFilterRangeIncomplete: 'Выберите обе даты для своего периода',
      ...
      statsFiltersBoardOnly:
        'Фильтры применяются только к потоку доски; показатели конвейера — по всей доске',
      ...
      statsPoints: '{{points}} п.п.',
      statsPrevious: 'Предыдущий период: {{value}}',
      statsReopened: 'Карточек переоткрыто',
      statsRuns: 'Прогонов',
      statsSessionFailureRate: 'Доля неудачных сессий агентов',
      statsSessions: 'Сессий агентов',
      statsSessionsNone: 'Сессии агентов не записаны',
      statsSessionsSince: 'Сессии агентов записываются с {{date}}',
      statsSessionsTitle: 'Сессии агентов по видам',
      statsSpend: 'Расходы',
      statsStagesNone: 'За этот период ни одна стадия тестов не завершилась',
      statsStagesTitle: 'Стадии тестов',
      statsTestingAccepted: 'Принято на пользовательском тестировании',
      statsTestingRejected: 'Отклонено на пользовательском тестировании',
      statsTestingSent: 'Отправлено на пользовательское тестирование',
      tabAccounts: 'Аккаунты',
      tabBuild: 'Сборка',
      tabDeployment: 'Деплой',
      tabStatistics: 'Статистика',
      tabTesting: 'Тесты',
      tasksDone: 'Выполнено задач',
      testRunning: 'идёт',
      testWaiting: 'ждёт слота контейнера (один из {{max}})',
      testsChip: 'Тесты: {{running}} идут · {{waiting}} ждут',
      testsNone: 'Ни один этап тестов не идёт и не ждёт',
      testsSummary:
        'Тестовый шлюз: {{running}} идут, {{waiting}} ждут слота контейнера (лимит {{max}})',
      threadsBusy: 'Потоки: занято {{busy}}/{{total}}',
      timeInStage: 'Время на этой стадии',
      title: 'Конвейер',
      toTop: 'В начало',
      totalTime: 'Общее время в конвейере',
      unitDays: 'д',
      unitHours: 'ч',
      unitMinutes: 'м',
      unitSeconds: 'с',
      unreachable: 'Конвейер: оркестратор недоступен',
      untitledCard: 'Карточка без названия',
      waiting: 'Ожидание в очереди',
      willApply: 'Будет поставлен Priority: {{level}}',
      willApplyTie:
        'Будет поставлен Priority: {{level}} — наравне с обгоняемой задачей, поэтому решат стадия и возраст',
      window5h: '5 часов',
      windowWeek: 'Неделя',
      windowWeekFable: 'Неделя (Fable)',
    },
  },
};
