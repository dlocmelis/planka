 ...
 *
 * The button element is forwarded so the panel can give the keyboard back to
 * it when it closes — see `BotChat.jsx`.
 */
const Launcher = React.forwardRef(
  ({ bot, position, unreadCount, isOpened, onToggle, onMove }, ref) => {
